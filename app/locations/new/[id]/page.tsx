...
import { FormControl,Input, TextField, Grid, Button, MenuItem, InputLabel, Select, Box,} from '@mui/material';
    ...
    const handleEvents = (events: EventApi[]) => {
      ...
      return (
        <>
          <form onSubmit={handleSubmit}>
            <Grid 
             ...
             >
              ...
              <Grid item >
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) => setNewGroup({ ...newGroup, dayOfWeek: parseInt(e.target.value as string) })}
                  >
              ...
              <Grid item xs={3}>
                <FormControl >
                  <LocalizationProvider dateAdapter={AdapterDateFns} localeText = {plPL.components.MuiLocalizationProvider.defaultProps.localeText}>
                    <MobileTimePicker
                     minTime ={new Date('2000-01-01T06:00')}
                     label="Początek"
                     ampm= {false}
                     value={new Date(`2000-01-01T${newGroup.timeS}:00`)}
                     onChange={(newValue) => {if (newValue !== null && newValue !== undefined) {
                      setNewGroup({...newGroup,
                            timeS: ` ${newValue.getHours().toString().padStart(2, '0')}:${
                            newValue.getMinutes().toString().padStart(2, '0')}`
                        })}}
                     }
                    />
                  ...
                  <LocalizationProvider dateAdapter={AdapterDateFns} localeText = {plPL.components.MuiLocalizationProvider.defaultProps.localeText}>
                    <MobileTimePicker
                     ...
                     onChange={(newValue) => {
                      ...
                      setNewGroup({...newGroup,
                            timeE: `${newValue.getHours().toString().padStart(2, '0')}:${
                            newValue.getMinutes().toString().padStart(2, '0')}
                            `
                        })}}
                     }
          ...
          <div style={{minWidth:'350px'}} className='border w-[95%]'>
        ...
        eventAdd={function(){console.log('dodano event')}}
