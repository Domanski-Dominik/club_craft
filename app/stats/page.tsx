  ...
  return (
    <Box
      ...
      <StyledTabs
        ...
        variant="scrollable"
        scrollButtons="auto">
        <StyledTab label="Płatności" {...a11yProps(0)} />
        <StyledTab label="Obecności" {...a11yProps(1)} />
      </StyledTabs>

      <CustomTabPanel value={value} index={0}>
        <Grid container width={"100%"} spacing={1} padding={2}>
          <Grid xs={6}>
            <FormControl
              fullWidth
              sx={{
      ...
      <CustomTabPanel value={value} index={1}>
        ...
        <Collapse in={info.presenceOption === "group"}>
          <Stack2
            ...
            <FormControl fullWidth sx={{ width: "50%", px: 0.5 }}>
              <InputLabel id="select-group">Grupa</InputLabel>
              <Select id="select-group" label="Grupa"></Select>
            </FormControl>
          </Stack2>
        </Collapse>
        <Divider variant="middle" />
