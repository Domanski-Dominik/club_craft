...
export function CustomNoResultsOverlay() {
	return (
		<StyledGridOverlayNoResults>
			...
			<Box sx={{ mt: 2 }}>Nie znaleziono wyników.</Box>
		</StyledGridOverlayNoResults>
	);
}
...
export function CustomNoRowsOverlay() {
	return (
		<StyledGridOverlayNoRows>
			...
			<Box sx={{ mt: 2 }}>Brak wyników</Box>
		</StyledGridOverlayNoRows>
	);
}

export const StyledDataGrid = styled((props: DataGridProps) => {
	// Połączenie domyślnych slotów z tymi, które są przekazywane jako props
	const combinedSlots = {
		noRowsOverlay: CustomNoRowsOverlay,
		noResultsOverlay: CustomNoResultsOverlay,
		...props.slots, // Nowe sloty, które zostaną przekazane
	};
